      ...
      <div className="container">
        ...
        <div className="detail-body">
          <div className="detail-main">
            ...
            {(project.github || project.demo || project.demos) && (
              <div className="detail-section">
                <h2>Links</h2>
                <div className="detail-links-list">
                  {project.github && (
                    <a href={project.github} target="_blank" rel="noopener noreferrer" className="detail-link">
                      ...
                      {project.github.includes('github.com') ? 'View on GitHub' : 'View Source Code'}
                    </a>
                  )}
                  {project.demo && (
                  ...
                  {project.demos && project.demos.map((d, i) => (
                    <a key={i} href={d.url} target="_blank" rel="noopener noreferrer" className="detail-link">
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        <polygon points="5 3 19 12 5 21 5 3"></polygon>
                      </svg>
                      {d.label}
